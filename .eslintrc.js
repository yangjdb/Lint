module.exports = {
    ...
    'rules': {
        ...
        // error; disallow await inside of loops
        'no-await-in-loop': 2,
        // off; 允许使用console进行代码调试
        'no-console': 0,
        // off; 允许使用debugger进行代码调试
        'no-debugger': 0,
        ...
        'no-label-var': 2,
        // warn; 避免初始化变量值为 undefined
        'no-undef-init': 1,
        // error; 禁止将undefined当成标志符
        'no-undefined': 2,
        // warn; 变量使用之前必须进行定义，函数除外
        ...
        // error; 强制可嵌套的块的最大深度
        'max-depth': [2, {max: 4}],
        // warn; 单行最多允许140个字符, 对包含url的行不进行此限制
        'max-len': [1, {'code': 140, 'ignoreUrls': true, 'ignoreComments': true, 'ignoreStrings': true, 'ignoreTemplateLiterals': true, 'ignoreRegExpLiterals': true}],
        // warn; 强制回调函数最大嵌套深度
        ...
        // error; import 排序
        'sort-imports': [2, {'ignoreCase': false, 'ignoreMemberSort': false, 'memberSyntaxSortOrder': ['single', 'all', 'multiple', 'none']}],
